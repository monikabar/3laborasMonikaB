    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.delete_note_activity:
                Intent addActivityIntent2 = new Intent(getApplicationContext(), com.example.third_assignment_template.DeleteNoteActivity.class);
                startActivity(addActivityIntent2);
                return true;
            default:
